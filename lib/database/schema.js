...
Schema.prototype.registerCollection = function(collectionName, schema) {
  ...
  for(var attr in schema) {
    ...
    if(hasOwnProperty(schema[attr], 'unique') || hasOwnProperty(schema[attr], 'index')) {
      var indice = new Indice(name, attr, this._connection, hasOwnProperty(schema[attr], 'unique'));
